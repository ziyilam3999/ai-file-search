<!-- copilot-instructions v2.4 | Last updated: 2025-12-23 -->
...
| **FM-5** | Tests without assert statements | STOP. Tests must use `assert`, not just print/return True. |
...
- [ ] Tests use `assert` statements (not just print/return)? → **FM-5**
